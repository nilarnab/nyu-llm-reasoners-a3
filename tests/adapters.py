...
def run_tokenize_prompt_and_output(
    ...
    res = run_tokenize_prompt_and_output_util(prompt_strs, output_strs, tokenizer)
    return res
...
def run_compute_entropy(logits: torch.Tensor) -> torch.Tensor:
    ...
    res = run_compute_entropy_util(logits)
...
def run_get_response_log_probs(
    ...
    """
    res = run_get_response_log_probs_util(model, input_ids, labels, return_token_entropy)
    return res
...
def run_masked_mean(tensor: torch.Tensor, mask: torch.Tensor, dim: int | None = None) -> torch.Tensor:
    ...
    return run_masked_mean_util(tensor, mask, dim)
